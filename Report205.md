...
| Сценарий                                  | Этап 1, с | Этап 2, с | Этап 3, с | Этап 4, с | Этап 5, с | Этап 6, с | Этап 7, с | Этап 8, с | Этап 9, с | Этап 10, с | Этап 11, с | Ссылка                                                                         |
|-------------------------------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|------------|------------|--------------------------------------------------------------------------------|
...
| Кэширование + SonarQube + PyLint + Bandit | 1         | 1         | 0         | 8         | 3         | 0         | 0         | 3         | 0         | 6          | 0          | https://github.com/aF-i-v-e/projectPP/actions/runs/14147166958/job/39635883118 |                                                                              
